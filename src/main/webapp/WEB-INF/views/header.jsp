...
<html>
 ...
 <table width="100%" cellpadding="0" cellspacing="0">
   ...
   <tr>
     ...
     <a style="color:white;" href="home">Home</a><!--change this to home-->
   - <a style="color:white;" href="login">Login</a><!--change this to login-->
   ...
   <%
       ...
       if(users!=null) out.println(users.get(0).getUsername());
       else{
   %>
