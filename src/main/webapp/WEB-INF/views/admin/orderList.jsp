			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.YouZiKun.model.Order o=(com.YouZiKun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.YouZiKun.dao.UserDao userDao=new com.YouZiKun.dao.UserDao();
						...
						<%
							...
							String paymentType=com.YouZiKun.model.Payment.findByPaymentId(con,n);
							 %>
